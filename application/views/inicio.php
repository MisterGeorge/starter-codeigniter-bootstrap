			...
			<div class="card mt-3">
			  	...
			  	<div class="card-body">
			  		<div class="row">
			  			<div class="col">
			  				<h4 class="card-title">
					    		<i class="fa fa-code-fork" aria-hidden="true"></i> {{ msg }}
					    	</h4>
			  			</div>
			  		</div>
			    	<div class="row">
			    		<div class="col-10">
			    			<p class="card-text text-justify">
					    		...
					    		<ul>
					    			...
					    			<li>
					    				<i class="icon-arrow-right-circle text-warning"></i>
					    				Bootstrap v4.3.1
					    			</li>
					    			<li>
					    				<i class="icon-arrow-right-circle text-warning"></i>
			    		...
			    		<div class="col-2">
			    			<img src="<?php echo base_url('dist/img/logo-vue.png'); ?>" class="img-fluid" alt="Logo Vue">
			    		</div>
			    	</div>
			    	<hr>
			    	<p class="card-text">
					...
					<code>application/views/inicio.php</code>

					<p class="card-text">
			    		Si desea editar y/o ver el módulo Admin ó Blog los encontrará localizados en:
			    	</p>
					<code>application/modules/admin/</code>
					<code>application/modules/blog/</code>

					<p class="card-text">
						Si usted está explorando CodeIgniter por primera vez, debe comenzar por leer la <a href="https://codeigniter.es/user_guide/index.html" target="_blank">Guía del Usuario</a>.
					</p>
			  	</div>
